...
from mmdet.apis import multi_gpu_test_d, single_gpu_test_d
...
def main():
    ...
    if not distributed:
        ...
        outputs1, outputs2 = single_gpu_test_d(model, data_loader, args.show, args.show_dir,
                                  args.show_score_thr)
    else:
        ...
        outputs1, outputs2 = multi_gpu_test_d(model, data_loader, args.tmpdir,
                                 args.gpu_collect)
